...
Six kinds — skins, ponds, titles, hats, outfits and extras — and one hundred and one looks between
them, of which forty-one are earned by playing, forty-one are sold for leafs and thirteen sit on
the season pass. Hats, outfits and extras are drawn as layers stamped onto the capybara's own
grid, so twenty-two hand-drawn shapes cover sixty-one items by palette swap.
...
| Wardrobe | 101 looks across 6 kinds — skins, ponds, titles, hats, outfits, extras — none of which moves a number |
